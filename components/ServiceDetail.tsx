...
const detailContent: Record<string, DetailRichContent> = {
  consulting: {
    about:
      "Our enterprise consulting practice delivers board-ready technology roadmaps and digitally transformational programs that align investments to measurable business outcomes, accelerate cloud modernization and migrations with secure, cost-efficient architectures, and implement compliance-first cybersecurity and risk frameworks that protect critical assets.\n\nWe design and operationalize DevOps and CI/CD pipelines to improve release velocity and reliability, build data analytics and governance platforms that turn data into executive-grade insights, and lead ERP and CRM selection and optimization to streamline core operations.\n\nOur services include IT service management and process optimization to tighten SLAs and incident response, application modernization and re-architecture for scalable, maintainable systems, and vendor sourcing with commercial negotiation to secure optimal partnerships.\n\nWe also deliver business continuity and disaster recovery planning, robotic process automation to reduce manual work, AI/ML prototyping and deployment for intelligent automation, and comprehensive change management, training, and adoption programs that ensure sustainable value, while continuously optimizing IT costs and infrastructure to maximize return on investment.",
    realWorldScenario: {
